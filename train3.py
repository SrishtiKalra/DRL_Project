...
parser.add_argument('--model_name', action="store", dest="model_name", default='DQNOLD', help="model name")
...
for e in range(1, num_episode - 8):
    ...
    if e % 5 == 0:
        if model_name == 'DQNOLD':
            agent.model.save('saved_models/DQNOLD_ep' + str(e) + '.h5')
